...
const SERVICES: Service[] = [
  ...
  {
    title: "Пейзаж и экспедиции",
    price: "по запросу",
    desc: "Локации для брендов, медиа и туризма. Продюсирую выезд под ключ: маршрут, разрешения, свет по сезону.",
    includes: ["логистика и скаутинг", "плёнка и средний формат", "печатные тиражи для офисов и отелей"],
    term: "Сроки — по маршруту",
  },
];
...
export default function Services() {
  ...
  return (
    <section id="services" className="scroll-mt-20 border-t border-line px-5 py-20 md:px-10 md:py-28">
      <SectionHead no="04 — Услуги" title="Процесс" note="Бриф → съёмка → отбор\n→ ретушь → передача" />
