 ...
 */
export const SITE = {
  name: "Арсений Бабанов — фотограф",
  url: "https://babanov.photo",
  ...
  defaultDescription:
    "Портрет, улица, архитектура, пейзаж, натюрморт и чёрно-белая фотография. Москва. Ищу свет и ловлю моменты.",
};
