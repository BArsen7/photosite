...
/** Эталонные EXIF-подписи (Canon R8 + парк оптики). Сами кадры в проде
 *  загружаются через админ-панель и хранятся в локальной базе. */
export const PHOTOS: Photo[] = [
  ...
  },
  {
    ...
    alt: "Девушка у окна в мягком дневном свете",
    title: "Аня, свет из окна",
    genre: "portrait",
    location: "Санкт-Петербург",
    year: 2024,
    camera: "Canon R8",
    lens: "EF 75-300mm ƒ/4.0-5.6",
    aperture: "4.0",
    shutter: "1/250",
    iso: 200,
    ratio: "4/5",
